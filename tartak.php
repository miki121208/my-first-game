...
<?php
	...
	echo 'Budynki:<br />';
	echo '<a href="tartak.php">Tartak</a> lvl '.$_SESSION['tartakLvl'];
	if($_SESSION['tartakLvl']<10)
	{
		echo'<form method="POST"><input type="submit" name="tartakUpgrade" value="Ulepsz" /> ';
		if(isset($_POST['tartakUpgrade']))
		{
			if(($_SESSION['drewno']>=($_SESSION['tartakLvl']*100))&&($_SESSION['kamien']>=($_SESSION['tartakLvl']*100)))
			{

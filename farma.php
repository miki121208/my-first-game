...
<?php
	...
	echo 'Budynki:<br />';
	echo '<a href="farma.php">Farma</a> lvl '.$_SESSION['farmaLvl'];
	if($_SESSION['farmaLvl']<10)
	{
		echo'<form method="POST"><input type="submit" name="farmaUpgrade" value="Ulepsz" /> ';
		if(isset($_POST['farmaUpgrade']))
		{
			if(($_SESSION['drewno']>=($_SESSION['farmaLvl']*100))&&($_SESSION['kamien']>=($_SESSION['farmaLvl']*100)))
			{

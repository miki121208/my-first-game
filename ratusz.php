...
<?php
	...
	echo 'Budynki:<br />';
	echo '<a href="ratusz.php">Ratusz</a> lvl '.$_SESSION['ratuszLvl'];
	if($_SESSION['ratuszLvl']<10)
	{
		echo'<form method="POST"><input type="submit" name="ratuszUpgrade" value="Ulepsz" /> ';
		if(isset($_POST['ratuszUpgrade']))
		{
			if(($_SESSION['drewno']>=($_SESSION['ratuszLvl']*100))&&($_SESSION['kamien']>=($_SESSION['ratuszLvl']*100)))
			{
	...
	echo '</form><br />';
	echo 'Ratusz to główny budynek w twojej wiosce';
?>

...
<?php
	...
	echo 'Budynki:<br />';
	echo '<a href="spichlerz.php">Spichlerz</a> lvl '.$_SESSION['spichlerzLvl'];
	if($_SESSION['spichlerzLvl']<10)
	{
		echo'<form method="POST"><input type="submit" name="spichlerzUpgrade" value="Ulepsz" /> ';
		if(isset($_POST['spichlerzUpgrade']))
		{
			if(($_SESSION['drewno']>=($_SESSION['spichlerzLvl']*100))&&($_SESSION['kamien']>=($_SESSION['spichlerzLvl']*100)))
			{
				...
				try
				{
					...
					$user_id = $_SESSION['id'];
					$building_id = $_SESSION['spichlerzID'];
	...
	echo '</form><br />';
	echo 'Spichlerz magazynuje twoje surowce';
?>

...
<?php
	...
	echo 'Budynki:<br />';
	echo '<a href="koszary.php">Koszary</a> lvl '.$_SESSION['koszaryLvl'];
	if($_SESSION['koszaryLvl']<10)
	{
		echo'<form method="POST"><input type="submit" name="koszaryUpgrade" value="Ulepsz" /> ';
		if(isset($_POST['koszaryUpgrade']))
		{
			if(($_SESSION['drewno']>=($_SESSION['koszaryLvl']*100))&&($_SESSION['kamien']>=($_SESSION['koszaryLvl']*100)))
			{
				...
				try
				{
					...
					$user_id = $_SESSION['id'];
					$building_id = $_SESSION['koszaryID'];
